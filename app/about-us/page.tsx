      ...
      <div className="z-10 w-full max-w-xl px-5 xl:px-0"> 
        <>
            <article className="mb-32">
                ...
                />
                <p className="my-2.5">
                    Achieve Global Safaris is an indigenous East African Safari Agency fully registered and licensed in Kampala Uganda. We drive travellers’ interests providing them with their desired ultimate safari experiences in Uganda and all around East Africa. Our committed staff has offered excellent services to several group clients and individual travellers over the years, as well as promoting Uganda-the pearl of Africa as the world’s best tourist destination.
                </p>
                <p className="my-2.5">
                ...
                <p className="my-2.5">
                    ...
                    We can make it to any destination of your choice being well equipped with reliable 4WD Toyota Land Cruisers, Supper custom, minibuses and other SUV and Sedan tour cars which are customized and comfortable for our clients.
                </p>
                <p className="my-2.5">
